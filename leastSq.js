...
exports.linearRegressionSlope = function(predictorArr, criterionArr) //http://onlinestatbook.com/2/regression/intro.html
{
...
exports.linearRegressionIntercept = function(predictorArr,criterionArr)
{
	var M_x = mean(predictorArr);
	var M_y = mean(criterionArr);
	var b = exports.linearRegressionSlope(predictorArr,criterionArr);
	return M_y - b*M_x;
}
